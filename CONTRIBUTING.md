...
Welcome to `creditFraud` contributor's guide.
...
If you experience bugs or general issues with `creditFraud`, please have a look
...
You can help improve `creditFraud` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`creditFraud` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `creditFraud`'s files. While this mechanism can
...
```
conda create -n creditFraud python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/creditFraud.git
   cd creditFraud
   ```
...
5. Install [pre-commit]:
   ...
   `creditFraud` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/creditFraud
[issue tracker]: https://github.com/<USERNAME>/creditFraud/issues
